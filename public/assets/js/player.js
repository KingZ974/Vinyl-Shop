$(document).ready(function () {
    ...
    */
    ...
    console.dir(tbPlaylist[0].title);
    ...
    */
    ...
    function displayCover(state) {
        $("#cover img").fadeOut(600, function() {
    ...
    function displayPlay() {
        playPause = true;
        $("#playPause img").attr("src", "./assets/images/pause-circle-regular.svg");
    }
    //fonction de gestion de l'affichage du bouton play quand la lecture est arretée
    function displayPause() {
        playPause = false;
        $("#playPause img").attr("src", "./assets/images/play-circle-solid.svg");
    }
